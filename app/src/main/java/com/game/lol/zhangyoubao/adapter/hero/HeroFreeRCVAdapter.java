 ...
 * ====================================
 */
public class HeroFreeRCVAdapter extends RecyclerView.Adapter<HeroFreeRCVAdapter.FreeHeroHolder> {
    private final AssetManager assets;
    private final DBHelperDao dbDao;
    private List<HeroFreeBean.DataBean.CurrentperiodBean> freeHeroIdList;
    private Context context;
    //    private SQLiteDatabase db;

    public HeroFreeRCVAdapter(Context context, List<HeroFreeBean.DataBean.CurrentperiodBean> freeHeroIdList) {
        this.freeHeroIdList = freeHeroIdList;
...
//        this.db = db;
    ...
    public void onBindViewHolder(FreeHeroHolder holder, final int position) {
        String id = freeHeroIdList.get(position).getId();
        DBHeroListBean heroListBean = dbDao.queryHeroListById(id);
